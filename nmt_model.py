...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.target_vocab_projection=nn.Linear(in_features=embed_size,out_features=hidden_size,bias=False)
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        for Y_t in torch.split(Y,1):
            ...
            dec_state,o_t,e_t=self.step(self,dec_state,enc_hiddens,enc_hiddens_proj,enc_masks)
